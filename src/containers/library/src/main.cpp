...
int main(void) {
    ...
    auto b33 = Book("Libro 33", "Author 33", "1111");
    auto b4 = Book("Libro 4", "Author 4", "2222");
    auto b5 = Book("Libro 5", "Author 5", "3333");
    auto b6 = Book("Libro 6", "Author 6", "4444");
    auto b7 = Book("Libro 7", "Author 7", "5555");
    c.LoanBook(b2);
    c.LoanBook(b33);
    c.LoanBook(b4);
    c.LoanBook(b5);
